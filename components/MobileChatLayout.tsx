...
const MobileChatLayout: FunctionComponent<MobileChatLayoutProps> = ({
  ...
  return (
    <div className="fixed bg-background top-0 inset-x-0 py-2 px-4 ">
      <div className="w-full flex justify-between items-center">
        <Link href="/" className={buttonVariants({ variant: "ghost" })}>
          <Icons.Logo className="w-auto h-6 text-purple-600 " />
        </Link>
        <Button
              ...
              <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10">
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-hidden bg-primary py-6 shadow-xl">
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-between">
                          <Dialog.Title className="text-base font-semibold leading-6 text-primary-foreground">
                            Dashboard
                          </Dialog.Title>
                        ...
                        <nav className="flex flex-1 flex-col">
                          ...
                          >
                            ...
                            <li className="-ml-6 mt-auto flex items-center">
                              ...
                              <SignOutButton className="h-full aspect-square text-primary-foreground" />
                            </li>
                          </ul>
                        </nav>
